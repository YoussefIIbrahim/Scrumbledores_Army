...
module.exports = function(mongoose) {
  ...
  var createTempUser = function(user, callback) {
    ...
    //{ $or:[ {'email':user[options.emailFieldName]}, {'username':user[options.usernameFieldName]}]}
    //options.persistentUserModel.findOne(query, function(err, existingPersistentUser) {
      options.persistentUserModel.findOne({ $or:[ {'email':user[options.emailFieldName]}, {'username':user[options.usernameFieldName]}]}, function(err, existingPersistentUser) {
      if (err) {
        return callback(err, null, null);
      }
